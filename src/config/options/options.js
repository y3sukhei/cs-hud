...
export default {
	...
	data() {
		return {  
			...
			playerImages:[
				{id:1, url :"/hud/img/player-img/team7/angarag.png"},
				{id:2, url :"/hud/img/player-img/team7/dulguun.png"},
				{id:3, url :"/hud/img/player-img/team7/enkhbold.png"},
				{id:4, url :"/hud/img/player-img/team7/naranjargal.png"},
				{id:5, url :"/hud/img/player-img/team7/walter.png"},
				{id:6, url :"/hud/img/player-img/team8/batzaya.png"},
				{id:7, url :"/hud/img/player-img/team8/dulkhuu.png"},
				{id:8, url :"/hud/img/player-img/team8/enkhjin.png"},
				{id:9, url :"/hud/img/player-img/team8/tselmuun.png"},
				{id:10, url :"/hud/img/player-img/team8/tsevegmed.png"},
			]
		}
	},
	mounted() {
